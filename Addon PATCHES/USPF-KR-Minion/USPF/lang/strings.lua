local strings = {
	...
	USPF_SETTINGS_PANEL_SUFFIX = "Settings",
	USPF_SETTINGS_RESET_MSG = "USPF settings reset to default.",
	...
	USPF_SETTINGS_SORT_LEGACY_ZONE = "Legacy Zone",
	USPF_SETTINGS_SORT_ZONE_NAME = "Zone Name",
	USPF_SETTINGS_SORT_DUNGEON_NAME = "Dungeon Name",
	...
	USPF_GUI_CHAR_SELECT_TOOLTIP = "Select a character to view. You must have logged in on the selected character with this addon active for information to populate.",
