...
local function USPF_CreateCharList()
	...
	-- tooltip text
	USPF_GUI_Header_CharList.data = {tooltipText = GetString(USPF_GUI_CHAR_SELECT_TOOLTIP)}
...
local function USPF_Initialized(eventCode, addonName)
	...
	ZO_CreateStringId("SI_BINDING_NAME_USPF_TOGGLE", GetString(SI_BINDING_NAME_USPF_TOGGLE))
