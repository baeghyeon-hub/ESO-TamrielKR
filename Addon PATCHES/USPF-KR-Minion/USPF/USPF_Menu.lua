...
local SORT_LABEL_LEGACY_ZONE = GetString(USPF_SETTINGS_SORT_LEGACY_ZONE)
local SORT_LABEL_ZONE_NAME = GetString(USPF_SETTINGS_SORT_ZONE_NAME)
local SORT_LABEL_DUNGEON_NAME = GetString(USPF_SETTINGS_SORT_DUNGEON_NAME)
...
USPF.Options = {
	...
	Sort = {
		SQS = {
			[SORT_LABEL_LEGACY_ZONE] = 1,
			[SORT_LABEL_ZONE_NAME] = 2,
		},
		D = {
			[SORT_LABEL_LEGACY_ZONE] = 1,
			[SORT_LABEL_ZONE_NAME] = 2,
			[SORT_LABEL_DUNGEON_NAME] = 3,
		},
		Names_SQS = {SORT_LABEL_LEGACY_ZONE, SORT_LABEL_ZONE_NAME},
		Names_D = {SORT_LABEL_LEGACY_ZONE, SORT_LABEL_ZONE_NAME, SORT_LABEL_DUNGEON_NAME},
	},
}
...
function USPF:SetupMenu(charId)
	...
	USPF.panelData = {
		type = "panel",
		name = ADDON_NAME,
		displayName = ADDON_NAME.." "..GetString(USPF_SETTINGS_PANEL_SUFFIX),
		author = ADDON_AUTHOR,
		...
		resetFunc = function() print(GetString(USPF_SETTINGS_RESET_MSG)) end,
	}
