...
local localization = {
    en = {
        ...
        DONATION = "Donate",
        PANEL_INFO_FONT = "EsoKR/fonts/univers67.otf|14|soft-shadow-thin",
    ...
    kr = { -- provided by TamrielKR
        ...
        RELOAD_UI_WARNING = "이 설정을 변경하면 효과를 적용하기 위해 UI 새로고침이 필요합니다.",
        RELOAD_DIALOG_TITLE = "UI 새로고침 필요",
        RELOAD_DIALOG_TEXT = "변경된 설정 중 UI 새로고침이 필요한 항목이 있습니다. 지금 새로고침하시겠습니까? 아니면 변경을 취소하시겠습니까?",
        RELOAD_DIALOG_RELOAD_BUTTON = "새로고침",
        RELOAD_DIALOG_DISCARD_BUTTON = "변경 취소",
    },
