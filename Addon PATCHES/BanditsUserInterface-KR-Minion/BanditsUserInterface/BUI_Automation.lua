...
--		{type="checkbox",	param="FeedSynergy"},
		...
		{type="button",	name=(BUI.Localization[BUI.language] and BUI.Localization[BUI.language].ReloadUIButton) or "Reload UI",func=function() SCENE_MANAGER:SetInUIMode(false) BUI.OnScreen.Notification(8, BUI.Loc("SETTINGS_ReloadingUI")) BUI.CallLater("ReloadUI",1000,ReloadUI) end},
		}
