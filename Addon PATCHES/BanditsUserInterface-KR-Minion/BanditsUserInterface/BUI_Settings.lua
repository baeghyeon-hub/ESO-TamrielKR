...
local function MenuChoice(key, fallback)
	if BUI.language=="kr" and BUI.KRChoices and BUI.KRChoices[key] then
		return BUI.KRChoices[key]
	end
	return fallback
end

local function MenuText(key, fallback)
	local locale=BUI.Localization[BUI.language]
	return locale and locale[key] or fallback
end

local function MenuChoiceDisplay(key, value, values)
	local choices=MenuChoice(key, values)
	for i,internal in pairs(values) do
		if internal==value then
			return choices[i]
		end
	end
	return value
...
local function ShowReloadNotification()
	BUI.OnScreen.Notification(8, BUI.Loc("SETTINGS_ReloadingUI"))
end
...
local function MenuMiscAdditional()
	...
	BUI.UI.Label(	"BUI_Menu_Move2_Label",	mode2,		{60,26},		{RIGHT,LEFT,-4,0},		BUI.UI.Font("standard",18,true), {.8,.8,.6,1}, {2,1}, MenuText("MoveModeDefault", "Default"),	false)
end
...
--	local Widgets_List,Widgets_List_Values=BUI.Menu.MakeList(BUI.Vars.Widgets)
	...
	{	type		="dropdown",
		name		="Theme",
		choices	=MenuChoice("Theme", {"Standard","Standard smooth","Standard flat","Custom gloss","Custom flat","Pink pony","Advanced"}),
--		choicesValues={1,2,3,4,5,6,7},
		...
		setFunc	=function(i,value)
			if i==BUI.Vars.Theme then
				...
				BUI.Vars.Theme=i BUI.Themes_Setup(true) SCENE_MANAGER:SetInUIMode(false) bui_a(MenuText("ThemeChanged", "Changing theme: Done"))
			end
		end,
	},
	--Frames Texture
	...
	{	type		="dropdown",
		name		="ChangeLanguage",
		choices	=MenuChoice("Language", {"en", "ru", "de", "fr", "jp", "it", "br", "pl", "es", "kr"}),
		getFunc	=function() return BUI.language end,
		setFunc	=function(i,value) SCENE_MANAGER:SetInUIMode(false) ShowReloadNotification() BUI.CallLater("Language",1000,SetCVar,"Language.2",value) end,
...
--]]
	...
	{	type		="dropdown",
		name		="TauntTimer",
		choices	=MenuChoice("TauntTimer", {"Progress bar","Bar and number","Number only","Disabled"}),
	...
	{	type		="dropdown",
		name		="ReticleResist",
		choices	=MenuChoice("ReticleResist", {"Current value","Detailed info","Disabled"}),
--		choicesValues={1,2,3},
...
--		disabled	=function() return BUI.API>100033 end,
	...
	{	type		="dropdown",
		name		="CastBar",
		choices	=MenuChoice("CastBar", {"Any ability","Cast time ability","Disabled"}),
	...
	{	type		="dropdown",
		name		="ReticleMode",
		choices	=MenuChoice("ReticleMode", {"Default","Crosshair","Rhomboid","Circular","Triangle 1","Triangle 2","Dotty","Brackets","Dots",[11]="Off"}),
...
--		type="submenu", name="PlayerHeader", controls={
	...
	{	type		="dropdown",
		name		="PlayerHeader",
		choices	=MenuChoice("PlayerFrameMode", {"Default frames","Default: pyramid","Bandits: default","Bandits: pyramid","Bandits: vertical","Disabled"}),
		getFunc	=function()
					if BUI.Vars.DefaultPlayerFrames then
						if BUI.Vars.RepositionFrames then return MenuChoice("PlayerFrameMode", {"Default frames","Default: pyramid","Bandits: default","Bandits: pyramid","Bandits: vertical","Disabled"})[2] else return MenuChoice("PlayerFrameMode", {"Default frames","Default: pyramid","Bandits: default","Bandits: pyramid","Bandits: vertical","Disabled"})[1] end
					elseif BUI.Vars.PlayerFrame then
						if BUI.Vars.FrameHorisontal then
							return BUI.Vars.RepositionFrames and MenuChoice("PlayerFrameMode", {"Default frames","Default: pyramid","Bandits: default","Bandits: pyramid","Bandits: vertical","Disabled"})[4] or MenuChoice("PlayerFrameMode", {"Default frames","Default: pyramid","Bandits: default","Bandits: pyramid","Bandits: vertical","Disabled"})[3]
						else return MenuChoice("PlayerFrameMode", {"Default frames","Default: pyramid","Bandits: default","Bandits: pyramid","Bandits: vertical","Disabled"})[5] end
					else
						return MenuChoice("PlayerFrameMode", {"Default frames","Default: pyramid","Bandits: default","Bandits: pyramid","Bandits: vertical","Disabled"})[6]
					end
				end,
		setFunc	=function(i,value)
					local modes=MenuChoice("PlayerFrameMode", {"Default frames","Default: pyramid","Bandits: default","Bandits: pyramid","Bandits: vertical","Disabled"})
					if value==modes[1] then
...
--		warning	=true,
	...
	{	type		="dropdown",
		name		="FramesBorder",
		choices	=MenuChoice("FramesBorder", {"Plain","Thin","Thin (the same)","Clockwork","Blade","Round","Dragon"}),
	...
	{	type		="dropdown",
		name		="PrimaryStat",
		choices	=MenuChoice("PrimaryStat", {"Default","Stamina","Magicka"}),
	...
	{	type		="dropdown",
		name		="CurvedFrame",
		choices	=MenuChoice("CurvedFrame", {"Disabled","Simple","Cone","Blades"}),
...
--		type="submenu", name="TargetHeader", controls={
	...
	{	type		="checkbox",
		...
		setFunc	=function(value)
			...
			if value then SCENE_MANAGER:SetInUIMode(false) ShowReloadNotification() BUI.CallLater("ReloadUI",1000,ReloadUI) return end
...
--		type="submenu",name="GroupHeader",controls={
	...
	{	type		="dropdown",
		name		="RaidStatValue",
		choices	=MenuChoice("RaidStatValue", {"Number","Percent","Disabled"}),
	...
	{	type		="dropdown",
		name		="RaidSort",
		choices	=MenuChoice("RaidSort", {"By name","Auto","By role","By main power","By level","By accname"}),
	...
	{	type		="dropdown",
		name		="StatShareUlt",
		choices	=MenuChoice("StatShareUlt", {"All","Horn only","Disabled"}),
	...
	{	type		="dropdown",
		name		="UltimateOrder",
		choices	=MenuChoice("UltimateOrder", {"Enabled","Auto","Disabled"}),
	...
	{	type		="dropdown",
		name		="GroupSynergy",
		choices	=MenuChoice("GroupSynergy", {"All","Tanks","Disabled"}),
...
--		disabled	=function() return not BUI.Vars.EnableStats end
	...
	{	type		="dropdown",
		...
		choices	=MenuChoice("Align", {[8]="Left",[128]="Center",[2]="Right"}),
--		choicesValues={LEFT,CENTER,RIGHT},
	...
	{	type		="dropdown",
		name		="BuffsPassives",
		choices	=MenuChoice("BuffsPassives", {"On one panel","On additional panel","Disabled"}),
		getFunc	=function() return MenuChoiceDisplay("BuffsPassives", BUI.Vars.BuffsPassives, {"On one panel","On additional panel","Disabled"}) end,
		setFunc	=function(i,value) BUI.Vars.BuffsPassives=({"On one panel","On additional panel","Disabled"})[i] BUI.Frames.PassiveBuffs_Init() end,
		disabled	=function() return not BUI.Vars.PlayerBuffs end,
	},
	--Passive Buffs Size
	{	type		="slider",
	...
	{	type		="dropdown",
		name		="PassivePSide",
		choices	=MenuChoice("Side", {"left","right"}),
		getFunc	=function() return MenuChoiceDisplay("Side", BUI.Vars.PassivePSide, {"left","right"}) end,
		setFunc	=function(i,value) BUI.Vars.PassivePSide=({"left","right"})[i] BUI.Frames.PassiveBuffs_Init() end,
		disabled	=function() return not BUI.Vars.PlayerBuffs or BUI.Vars.BuffsPassives~="On additional panel" or not BUI.Vars.PassiveProgress end,
	},
	{	type		="checkbox",
...
--		choicesValues={LEFT,CENTER,RIGHT},
	...
	{	type		="dropdown",
		...
		choices	=MenuChoice("Direction", {"horisontal","vertical"}),
		getFunc	=function() return MenuChoiceDisplay("Direction", BUI.Vars.CustomBuffsDirection, {"horisontal","vertical"}) end,
		setFunc	=function(i,value) BUI.Vars.CustomBuffsDirection=({"horisontal","vertical"})[i] BUI.Frames.CustomBuffs_Init() end,
		disabled	=function() return not BUI.Vars.EnableCustomBuffs end,
	},
	{	type		="checkbox",
	...
	{	type		="dropdown",
		...
		choices	=MenuChoice("Side", {"left","right"}),
		getFunc	=function() return MenuChoiceDisplay("Side", BUI.Vars.CustomBuffsPSide, {"left","right"}) end,
		setFunc	=function(i,value) BUI.Vars.CustomBuffsPSide=({"left","right"})[i] BUI.Frames.CustomBuffs_Init() end,
		disabled	=function() return not BUI.Vars.EnableCustomBuffs or not BUI.Vars.CustomBuffsProgress or BUI.Vars.CustomBuffsDirection~="vertical" end
	},
	{	type="editbox",
		name		="CustomBuffsAdd",
	...
	{	type		="dropdown",
		...
		choices	=MenuChoice("Direction", {"horisontal","vertical"}),
		getFunc	=function() return MenuChoiceDisplay("Direction", BUI.Vars.SynergyCdDirection, {"horisontal","vertical"}) end,
		setFunc	=function(i,value) BUI.Vars.SynergyCdDirection=({"horisontal","vertical"})[i] if BUI.Vars.SynergyCdDirection~="vertical" then BUI.Vars.SynergyCdProgress=false end BUI.Frames.SynergyCd_Init() end,
		disabled	=function() return not BUI.Vars.EnableSynergyCd end,
	},
	{	type		="checkbox",
	...
	{	type		="dropdown",
		name		="SynergyCdPSide",
		choices	=MenuChoice("Side", {"left","right"}),
		getFunc	=function() return MenuChoiceDisplay("Side", BUI.Vars.SynergyCdPSide, {"left","right"}) end,
		setFunc	=function(i,value) BUI.Vars.SynergyCdPSide=({"left","right"})[i] BUI.Frames.SynergyCd_Init() end,
		disabled	=function() return not BUI.Vars.EnableSynergyCd end,
	}}},
	--Widgets
...
--]]
	...
	{	type		="dropdown",
		...
		choices	=MenuChoice("NameFormat", {"Name","@AccName","Name@AccName"}),
...
function BUI.Menu.Update(setting, value, reload)
	...
	if reload then SCENE_MANAGER:SetInUIMode(false) ShowReloadNotification() BUI.CallLater("ReloadUI",1000,ReloadUI) end
end
...
function BUI.Menu.Reset(context)
	...
	if not context then
		...
		SCENE_MANAGER:SetInUIMode(false) ShowReloadNotification() BUI.CallLater("ReloadUI",1000,ReloadUI)
	--Reset unit frames
...
--			d(WidgetId)
			if WidgetId then
				...
				bui_a(MenuText("AdditionalEffectRemoved", "Additional effect was removed"),SOUNDS.NEGATIVE_CLICK)
...
--	label:SetHandler("OnMouseExit", ZO_Tooltips_HideTextTooltip)
	local array=MenuChoice("WidgetSound", {"Activation","Deactivation","Both","Disabled"})
...
local function MoveFramesButtons()
	...
	BUI.UI.SimpleButton("BUI_Menu_Move_B1", BanditsUI, {16,16}, {TOPRIGHT,TOPRIGHT,0,0}, "/esoui/art/miscellaneous/gamepad/arrow_down.dds", false,
		...
		MenuText("MoveAnchorCenter", "Center frame by anchor"))
	...
	BUI.UI.SimpleButton("BUI_Menu_Move_B2", BanditsUI, {16,16}, {TOPRIGHT,TOPRIGHT,0,0}, "/esoui/art/icons/mapkey/mapkey_dock.dds", false,
		...
		MenuText("MoveAnchorSet", "Set frame as anchor"))
...
--			BUI_Menu_Move_B1:SetHidden(true) BUI_Menu_Move_B2:SetHidden(true) BUI_Menu_Move_B3:SetHidden(true) BUI_Menu_Move_B4:SetHidden(true)
		...
		MenuText("MoveTempHide", "Temporarily hide"))
	...
	BUI.UI.SimpleButton("BUI_Menu_Move_B4", BanditsUI, {16,16}, {TOPRIGHT,TOPRIGHT,0,0}, "/esoui/art/guild/gamepad/gp_guild_menuicon_customization.dds", false,
		...
		MenuText("WidgetSettings", "Settings"))
